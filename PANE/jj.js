...
btn_circle.onclick = () => set_tool('line')
btn_line.onclick = () => set_tool('circle')
...
function draw(event) {
    ...
    ctx.strokeStyle = document.getElementById('colorPi').value
    ctx.lineWidth = document.getElementById('lineWid').value
